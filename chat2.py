...
s.bind(("192.168.31.204",50001)) #write your local IP here
nm = input("ENTER YOUR NAME : ")
print("\nType 'quit' to exit.")

#set IP address and the port number of the other user
...
#Tow thread for sending and receiving data at the same time
